...
<xsl:template name="vdex_classification_referentiekader_taal_en_rekenen_czp_2009_newToOld">

<!-- Bepaal of er een waarde vervangen moet worden en dus een classificatie moet worden aangemaakt -->
<xsl:variable name="createClassification">
<xsl:for-each select="key('classification-by-newIdvdex_classification_referentiekader_taal_en_rekenen_czp_2009',descendant::*[local-name() = 'id'])">
<xsl:choose>
<xsl:when test="descendant::*[local-name() = 'id'] = 'd5f99b58-31be-4ffc-89f4-9d7c65526879' and key('classification-by-oldIdvdex_classification_referentiekader_taal_en_rekenen_czp_2009','1F') != ''"/>
<xsl:when test="descendant::*[local-name() = 'id'] = '86d05d5a-8dfa-422b-820c-50019985426d' and key('classification-by-oldIdvdex_classification_referentiekader_taal_en_rekenen_czp_2009','1S') != ''"/>
<xsl:when test="descendant::*[local-name() = 'id'] = '5eac0434-a6fc-4499-9710-3d6b800973a3' and key('classification-by-oldIdvdex_classification_referentiekader_taal_en_rekenen_czp_2009','2F') != ''"/>
<xsl:when test="descendant::*[local-name() = 'id'] = 'fadc20aa-082e-4e80-8a83-830c4006f236' and key('classification-by-oldIdvdex_classification_referentiekader_taal_en_rekenen_czp_2009','2S') != ''"/>
<xsl:when test="descendant::*[local-name() = 'id'] = 'f1d56c9e-373a-4051-9ce9-81a01b812de7' and key('classification-by-oldIdvdex_classification_referentiekader_taal_en_rekenen_czp_2009','3F') != ''"/>
<xsl:when test="descendant::*[local-name() = 'id'] = '2be1fbb4-d46f-44f8-9aff-d2bbf5108a18' and key('classification-by-oldIdvdex_classification_referentiekader_taal_en_rekenen_czp_2009','3S') != ''"/>
<xsl:when test="descendant::*[local-name() = 'id'] = '5ec6d733-a3b2-46db-9d42-72b4be4f7750' and key('classification-by-oldIdvdex_classification_referentiekader_taal_en_rekenen_czp_2009','4F') != ''"/>
<xsl:when test="descendant::*[local-name() = 'id'] = '7bae4f16-ed94-4739-9d42-d0842dee7c90' and key('classification-by-oldIdvdex_classification_referentiekader_taal_en_rekenen_czp_2009','4S') != ''"/>
<xsl:otherwise>
<xsl:text>unmatched</xsl:text>
...
<xsl:text>http://purl.edustandaard.nl/vdex_classification_referentiekader_taal_en_rekenen_czp_2009.xml</xsl:text>
</xsl:element>
</xsl:element>
<xsl:call-template name="writeTaxonsNewToOldvdex_classification_referentiekader_taal_en_rekenen_czp_2009"/>
</xsl:element>
</xsl:element>
</xsl:if>
</xsl:template>
...
<xsl:when test="node() = '86d05d5a-8dfa-422b-820c-50019985426d' and not(key('classification-by-oldIdvdex_classification_referentiekader_taal_en_rekenen_czp_2009','1S'))">
<xsl:element name="{$usedNamespace}:taxon">
<xsl:element name="{$usedNamespace}:id">
...
<xsl:when test="node() = '5eac0434-a6fc-4499-9710-3d6b800973a3' and not(key('classification-by-oldIdvdex_classification_referentiekader_taal_en_rekenen_czp_2009','2F'))">
<xsl:element name="{$usedNamespace}:taxon">
<xsl:element name="{$usedNamespace}:id">
...
<xsl:when test="node() = 'fadc20aa-082e-4e80-8a83-830c4006f236' and not(key('classification-by-oldIdvdex_classification_referentiekader_taal_en_rekenen_czp_2009','2S'))">
<xsl:element name="{$usedNamespace}:taxon">
<xsl:element name="{$usedNamespace}:id">
...
<xsl:when test="node() = 'f1d56c9e-373a-4051-9ce9-81a01b812de7' and not(key('classification-by-oldIdvdex_classification_referentiekader_taal_en_rekenen_czp_2009','3F'))">
<xsl:element name="{$usedNamespace}:taxon">
<xsl:element name="{$usedNamespace}:id">
...
<xsl:when test="node() = '2be1fbb4-d46f-44f8-9aff-d2bbf5108a18' and not(key('classification-by-oldIdvdex_classification_referentiekader_taal_en_rekenen_czp_2009','3S'))">
<xsl:element name="{$usedNamespace}:taxon">
<xsl:element name="{$usedNamespace}:id">
...
<xsl:when test="node() = '5ec6d733-a3b2-46db-9d42-72b4be4f7750' and not(key('classification-by-oldIdvdex_classification_referentiekader_taal_en_rekenen_czp_2009','4F'))">
<xsl:element name="{$usedNamespace}:taxon">
<xsl:element name="{$usedNamespace}:id">
...
<xsl:when test="node() = '7bae4f16-ed94-4739-9d42-d0842dee7c90' and not(key('classification-by-oldIdvdex_classification_referentiekader_taal_en_rekenen_czp_2009','4S'))">
<xsl:element name="{$usedNamespace}:taxon">
<xsl:element name="{$usedNamespace}:id">
<xsl:value-of select="'4S'"/>
</xsl:element>
<xsl:element name="{$usedNamespace}:entry">
<xsl:element name="{$usedNamespace}:langstring"><xsl:attribute name="xml:lang"><xsl:text>nl</xsl:text></xsl:attribute><xsl:value-of select="'4S'"/></xsl:element>
</xsl:element>
